        ...
        return (
          ...
          <Card.Body>
            ...
            <Form.Group className="mb-3" controlId="formBasicFirstname">
              ...
              <Form.Control type="text" placeholder="First name" name="name1" value={name1} onClick={(e) => setName(e.target.value)} />
            </Form.Group>
            ...
            <Link to="/signin">
            <Button variant="primary" style={{marginLeft: '42%'}} type="submit" >
                Sign up
              </Button>
            </Link>
            </Form>
